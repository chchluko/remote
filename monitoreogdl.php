<?
$tb = 'monitoreogdl'; //tabla referencia
...
<html lang="es">
	...
	<body>	
	<div>
	<p><font color="#003366" size="6" face="Verdana, Arial, Helvetica, sans-serif"><em><strong>Monitoreo de Enlaces GDL<span id="livedate"> <?php echo date("d-m-Y"); ?></span><span id="liveclock"></span></strong></em></font></p>
  ...
  <!--	<font face="Verdana, Arial, Helvetica, sans-serif">-->
		...
		$result = mysql_query("select id, ip_sucursal as host, nombre_sucursal as services, sitio from $tb order by id");
                 ...
                 if(data == false)
                            {
                                ...
                                if (parseInt(data) > rng){
				                    ...
				                    var dataString = 'id='+ idx + '&mdia=' + parseInt(data) + '&tb=' + tb;
				                         $.ajax({
				                         type: "POST",
				                         url: "upbita.php",
				                         data: dataString
